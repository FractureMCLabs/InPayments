...
import { connect, disconnect, signMessage, getBalance, getEnsAvatar, getEnsName, getAccount, switchChain, watchAccount, watchConnectors } from '@wagmi/core';
...
export class Web3Modal extends Web3ModalScaffold {
    ...
    syncConnectors(connectors) {
        ...
        const coinbaseConnector = filteredConnectors.find(c => c.id === CoreConstants.CONNECTOR_RDNS_MAP[coinbaseSDKId]);
        filteredConnectors.forEach(({ id, name, type, icon }) => {
            const shouldSkip = (coinbaseConnector && id === coinbaseSDKId) || ConstantsUtil.EMAIL_CONNECTOR_ID === id;
            if (!shouldSkip) {
                w3mConnectors.push({
                    id,
